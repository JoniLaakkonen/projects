...
import 'slick_state.dart';
import 'utils.dart';

abstract class SlickSliderController {
  bool get ready;
  ...
  factory SlickSliderController() => SlickSliderControllerImpl();
}

class SlickSliderControllerImpl implements SlickSliderController {
  final Completer<Null> _readyCompleter = Completer<Null>();

  SlickState? _state;

  set state(SlickState? state) {
    _state = state;
  ...
  void _setModeController() =>
      _state!.changeMode(SlickPageChangedReason.controller);
  ...
  /// Animates the controlled [SlickSlider] to the next page.
  ///
  ...
  /// Animates the controlled [SlickSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  @override
  ...
  /// Changes which page is displayed in the controlled [SlickSlider].
  ///
  ...
  /// Animates the controlled [SlickSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  @override
  ...
  /// Starts the controlled [SlickSlider] autoplay.
  ///
  /// The slick will only autoPlay if the [autoPlay] parameter
  /// in [SlickOptions] is true.
  @override
  void startAutoPlay() {
    _state!.onResumeTimer();
  }

  /// Stops the controlled [SlickSlider] from autoplaying.
  ///
  /// This is a more on-demand way of doing this. Use the [autoPlay]
  /// parameter in [SlickOptions] to specify the autoPlay behaviour of the slick.
  @override
  void stopAutoPlay() {
    _state!.onResetTimer();
  }
